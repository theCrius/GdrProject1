...
<div class="DivPrincipale">
    ...
    <a href="{{route('registrati2',[3,$token])}}" title='Exo'><img id='razzaDestra' 
            src="/img/imgHomeEsterna/imgIscrizione/exo.png" alt=""></a>
    <a href="{{route('registrati2',[2,$token])}}" title='Insonni'><img id='razzaSinistra'
            src="/img/imgHomeEsterna/imgIscrizione/insonni.png" alt=""></a>
    <a href="{{route('registrati2',[1,$token])}}" title='Umani'><img id='razzaCentrale'
