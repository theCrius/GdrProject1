...
window.changeUserBox.showWarning= function (link){
    ...
    window.changeUserBox.showBox('Sei Sicuro?','Cosifacendo questo account verrà eliminato ma ti arriverà per email un link per crearne un altro e riceverai tutti i tuoi soldi perdendo però 1/4 dei tuoi EXP')
